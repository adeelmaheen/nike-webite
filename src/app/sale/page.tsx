        ...
        <div className="w-[80%]">
          ...
          <div className="flex sm:flex-col md:flex-row lg:flex-row justify-between mt-5 sm:flex-nowrap md:flex-wrap lg:flex-nowrap">
            ...
            <div>
              ...
              <h1 className="font-bold font-sans pt-2">Men&apos;s T-Shirt</h1> {/* Fix here */}
            ...
            <div>
              ...
              <h1 className="font-bold font-sans pt-2">Men&apos;s Shoes</h1> {/* Fix here */}
        ...
        <div id="products" className="w-full flex justify-center items-center mt-10 mb-1">
          ...
          <div className="w-[80%]">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex">
                <h1 className="text-gray-800 font-bold sm:text-md md:text-3xl lg:text-3xl pt-4">Explore Our Products</h1>
              </div>
            </div>

            <div className="flex sm:flex-col md:flex-row lg:flex-row justify-between mt-5 sm:flex-nowrap md:flex-wrap lg:flex-nowrap">
              {/* repeat product boxes as needed */}
